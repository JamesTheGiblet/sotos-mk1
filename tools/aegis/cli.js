...
if (command === 'status') {
  ...
  console.log('\n' + '═'.repeat(70));
  console.log('️  AEGIS COMPLIANCE STATUS');
  ...
  if (strategyId && validationFile && fs.existsSync(validationFile)) {
    ...
    console.log('   ⚠️  Usage: node cli.js record <strategy-id> <validation-file>');
  }
  ...
  if (!isNaN(days)) {
    ...
    console.log('   ⚠️  Usage: node cli.js days <number>');
  }
  ...
  console.log('\n' + '═'.repeat(60));
  console.log('🛡️  AEGIS — Compliance Framework');
  console.log('═'.repeat(60));
  console.log('   Commands:');
  console.log('     node cli.js status              Show compliance status');
  console.log('     node cli.js report              Generate compliance report');
  console.log('     node cli.js ready               Check if ready for live trading');
  console.log('     node cli.js days <number>       Update dry run days (Lock 1)');
  console.log('     node cli.js apikey <true/false> Set API key status (Lock 3)');
  console.log('     node cli.js record <id> <file>  Record strategy validation (Lock 2)');
  console.log('\n   Examples:');
  console.log('     node cli.js status');
  console.log('     node cli.js days 15');
  console.log('     node cli.js apikey true\n');
}
